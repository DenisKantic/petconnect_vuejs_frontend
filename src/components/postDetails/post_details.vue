<template>
  ...
  <v-container class="mt-6 d-flex flex-column flex-md-row">
    <div class="left-side">
    ...
    <div class="right-side">
      ...
      <v-row>
        <v-col v-for="(card, index) in cards" :key="index" cols="12" md="6">
          <v-card class="mx-auto" :title="card.title" :subtitle="card.subtitle" link>
          </v-card>
        </v-col>
    ...
    <v-btn color="primary" class="mt-6" width="50%" variant="outlined">Kontaktiraj me</v-btn>
    </div>
  </v-container>
</template>
